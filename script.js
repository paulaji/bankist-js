'use strict';
// Replacing 'Number' with '+' because it converts string type into number because of type coercion
...
btnLoan.addEventListener('click', function (e) {
  ...
  const amount = Math.floor(inputLoanAmount.value); // rounding off to prev value
